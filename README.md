...
2. Create a Google App and get the Client ID and Client Secret values. (Specify callback URL as `http://localhost:8080/login/oauth2/code/google` for development, uncheck Web hooks)
3. Add those values in `application.yml`
4. Run the Spring Boot App. You should be able to login with GitHub
